...
public class WhItemTouchCallback extends ItemTouchHelper.Callback {
    ...
    @Override
    public boolean isLongPressDragEnabled() {//可以尽心长按拖动
        return true;
    }

    @Override
    public boolean isItemViewSwipeEnabled() {//进行侧滑删除
        return true;
    }
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        int dragFlags = ItemTouchHelper.UP | ItemTouchHelper.DOWN;//上下滑动
        int swipeFlags = ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT;//左右推动
